...
describe('注册转化事实修复任务', () => {
  ...
  it('扫描任意年龄的缺失事实用户，每批最多 100 个且事件 ID 只由用户 ID 决定', async () => {
