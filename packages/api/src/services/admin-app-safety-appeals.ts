import type { AppAppealReviewState, AppSafetyAppealStatus } from '@meigallery/shared'
...
const APPEAL_SELECT = `
  SELECT appeal.id, security.account_public_id,
         appeal.report_id, appeal.appeal_type, appeal.statement_text,
         appeal.status, appeal.review_state, appeal.user_visible_status, appeal.user_visible_message,
         ...
         appeal.submitted_at, appeal.updated_at,
