...
export type Bindings = {
  ...
  APP_AUTH_TERMS_URL?: string
  APP_AUTH_PRIVACY_URL?: string
  APP_AUTH_PLATFORM_NOTICE_URL?: string
  APP_AUTH_ELIGIBILITY_URL?: string
  APP_AUTH_TURNSTILE_SITE_KEY?: string
  APP_MEMBERSHIP_ENABLED?: string
  APP_MEMBERSHIP_ADMIN_ENABLED?: string
  ...
  APP_SAFETY_PRODUCTION_READY?: string
  APP_SAFETY_APPEALS_ENABLED?: string
  ...
  APP_WALLET_PRODUCTION_READY?: string
  APP_INTERACTION_COLLECTIONS_ENABLED?: string
  APP_INTERACTION_COLLECTIONS_POLICY_VERSION?: string
  APP_INTERACTION_COLLECTIONS_PRODUCTION_READY?: string
  ...
  APP_TAXONOMY_ENABLED?: string
  APP_TAXONOMY_ADMIN_ENABLED?: string
  APP_TAXONOMY_CATALOG_VERSION?: string
  APP_TAXONOMY_PRODUCTION_READY?: string
  APP_RECOMMENDATION_ENABLED?: string
  ...
  APP_RUNTIME_ENABLED?: string
  APP_RUNTIME_PRODUCTION_READY?: string
  APP_RUNTIME_POLICY_VERSION?: string
  APP_RUNTIME_SERVICE_MODE?: string
  APP_RUNTIME_MINIMUM_CLIENT_VERSION?: string
  APP_RUNTIME_LATEST_CLIENT_VERSION?: string
  APP_RUNTIME_UPGRADE_URL?: string
  APP_RUNTIME_STATUS_URL?: string
