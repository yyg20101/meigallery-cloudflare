...
const activeTab = ref<'reports' | 'runtime'>('reports')
...
function priorityClass(priority: AdminSafetyReportSummary['priority']) {
  ...
  <div class="min-w-0 space-y-5">
    <div>
      ...
      <p class="mt-1 max-w-4xl text-sm leading-6 text-gray-600">
        举报队列默认不返回说明或消息正文；审核员领取案件后，才可按 safety_review 目的读取目标与前后各一条的最小证据窗口。
      </p>
    </div>
