...
function getCoverPreviewUrl(): string | null {
  if (!coverKey.value || !createdGalleryId.value) return null
  if (coverKey.value.startsWith('http')) return coverKey.value
  return `${baseURL}/api/media/cover/${createdGalleryId.value}`
}
