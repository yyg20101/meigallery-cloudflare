...
function adminAttributionResponse(pathname, searchParams) {
  ...
  if (pathname.endsWith('/platforms')) return { data: [{ provider: 'meta', environment: 'production', destinationConfigured: true, serverCredentialConfigured: true, testCredentialConfigured: true, mode: 'test', state: 'verified', verifiedAt: '2026-07-12T00:00:00.000Z', verifiedCommit: 'a'.repeat(40) }] }
