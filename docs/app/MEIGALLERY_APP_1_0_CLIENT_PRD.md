...
- 合规新话题和会员申请在 1 个服务日内完成首次处理的比例均不低于 90%；该指标用于判断是否扩量，不替代功能验收。
...
1. 用户选择目标等级，查看完整权益、限制、平台接收说明和服务时段。
2. 用户提交站内会员申请；表单包含期望等级、已验证联系方式、可选申请说明和人工处理确认。
...
用户可见服务口径：“服务时段每日 10:00–22:00；会员申请通常在 1 个服务日内处理。”
...
- 服务时间：每日 10:00–22:00，按首发服务时区计算；对用户说明“通常在 1 个服务日内处理”，但不保证固定回复时间。
- 平台运营只回答已公开资料、图库、内容更新和平台服务问题；需要本人确认时必须说明平台无法代表本人回答。
- 禁止以真人第一人称编造经历、观点、情感、行程或关系，禁止提供未公开联系方式、精确位置或见面承诺。
- 服务时段内至少 1 名在岗运营和 1 名可接替人员；单人每个服务日建议最多承接 30 个首次响应的新话题，同时待回复不超过 20 个。
...
| C-04 | 会员获取闭环 | 用户站内申请、管理员审核发放；通常 1 个服务日内首次处理 |  |
| C-05 | 平台运营服务 | 每日 10:00–22:00；不保证固定回复；队列满载时暂停新话题 |  |
