...
- 当前保留 `docs/superpowers/specs/2026-07-08-meta-capi-attribution-layer-design.md` 作为 Meta CAPI 与归因层的下一阶段设计输入；该设计尚未完全实施。
...
- Meta Conversions API 服务端回传和去重层，按当前 Meta CAPI 设计单独实施。
