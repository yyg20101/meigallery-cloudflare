...
export default [
  ...
  {
    files: ['packages/web/app/{pages,components,layouts,plugins,composables}/**/*.{ts,vue}'],
    rules: {
  ...
  {
    files: ['packages/web/app/plugins/attribution.client.ts'],
    rules: {
      'no-restricted-imports': ['error', {
        patterns: [
          '~/adapters/metaPixel.client',
